...
class servicenow_reporting_integration::event_management (
  ...
  Optional[String[1]] $failures_event_severity                        = 'Minor',
  Optional[String[1]] $corrective_changes_event_severity              = 'Warning',
  Optional[String[1]] $intentional_changes_event_severity             = 'OK',
  Optional[String[1]] $pending_corrective_changes_event_severity      = 'Warning',
  Optional[String[1]] $pending_intentional_changes_event_severity     = 'OK',
  Optional[String[1]] $no_changes_event_severity                      = 'OK',
